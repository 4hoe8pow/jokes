...
| 対象ユーザー | 国内総合制作現場（VFX、モーショングラフィックス、実写合成など） |
| 特徴 | スイッチャー対応、フレームレンジ・FPS自動補正、ワンクリック操作 |
...
| **Export AE** | 選択カメラ/NullをAEに直コンポ反映 | JSX生成不要でワンクリック出力、選択オプションを自動適用 |
